...
export function InfiniteCanvas({ containerRef, viewport, backgroundMode = "lines", activeTool = "hand", onViewportChange, onCanvasMouseDown, onCanvasDeselect, onCanvasDoubleClick, onContextMenu, onDrop, children }: InfiniteCanvasProps) {
